    ...
    <div className="max-w-[270px] md:max-w-[393px] md:h-[21rem] pb-0 col-span-full lg:col-span-4 text-white p-8 rounded-xl shadow-lg mb-8 md:mb-0 bg-purple-700 mx-auto">
      <div className="">
        ...
        <div className="md:h-1 flex justify-around items-center mt-12 bg-purple-700 w-full border-t-black">
          <button className="text-center border-t-[1px] border-black pt-3 pb-6 px-[31px] md:px-[53px] hover:shadow-2xl bg-purple-700 hover:bg-purple-950 rounded-bl-xl">
            SPONSOR
          </button>
          <button className="flex gap-0 md:gap-4 border-t-[1px] border-black border-l-[1px] s pt-3 pb-6 px-[31px] md:px-[53px] hover:shadow-2xl bg-purple-700 hover:bg-purple-950 rounded-br-xl">
